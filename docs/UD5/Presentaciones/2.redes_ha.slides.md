...
![Topologías](topologias.jpg)<!-- .element width="80%" -->
...
![Topología en Anillo](TopologiaAnillo.png)<!-- .element width="80%" -->

--

### Topología en malla

![Topología en malla](topologiaMalla.png)<!-- .element width="80%" -->

--

### Topología Jerárquica

![Red Jerárquica](red.jerarquica.png)<!-- .element width="80%" -->
...
![Red Jerrárquica redundancia](red.jerarquica.redundancia.png)<!-- .element width="80%" -->
...
![LACP](LACP.jpg)<!-- .element width="70%" -->

--

### Agregación de enlaces: Switches

![Etherchannel](image-1.webp)<!-- .element width="80%" -->
...
![VRRP](VRRP.router.png)<!-- .element width="80%" -->
...
![Balanceador de carga](balanceador_carga.png)<!-- .element width="80%" -->
