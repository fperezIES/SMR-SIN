...
### [Ejercicio 1: Investigación de Especificaciones de Fiabilidad de Discos Duros y Unidades SSD](especificaciones_fiabilidad.md)

### [Ejercicio 2: Comprensión de la Fiabilidad de los Discos Duros según el Estudio de Google](fiabilidadDiscosGoogle.md)

### [Ejercicio 3: Comprobación del estado SMART de las unidades de disco](SMART.md)
