...
### 1.2 **Control del Acceso a la Información Personal**
...
#### 1.3.2 **Encargados del Tratamiento**:
...
#### 1.3.3 **Delegado de Protección de Datos (DPO)**:
...
## 3 **Legislación sobre Servicios de la Sociedad de la Información y Comercio Electrónico**
...
### 4.1 **Ley 25/2007, de Conservación de Datos relativos a las Comunicaciones Electrónicas y a las Redes Públicas de Comunicaciones**
...
### 4.2 **Real Decreto-ley 12/2018, de Seguridad de las Redes y Sistemas de Información (Transposición de la Directiva NIS)**
...
### 4.3 **Esquema Nacional de Seguridad (ENS)**
...
### 4.4 **Ley 36/2015, de Seguridad Nacional**
...
### 4.5 **Ley 8/2011, por la que se establecen medidas para la protección de las infraestructuras críticas**
...
### 4.6 **Reglamento de Seguridad de las TIC (R.S.TIC)**
