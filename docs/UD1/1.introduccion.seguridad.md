...
### ⁠1.2.1. **Imposibilidad de predecir todas las amenazas**
...
### ⁠1.2.2. **Confianza en la criptografía**
...
!!! Info "Definiciones de Seguridad Informática"

    === "Según la noma ISO27002"
...
![Triada CIA](img/01/CIA.png){width=50%}
/// caption
...
![](img/Autenticidad-Trazabilidad.png)
...
*  INCIBE - Gestión de riesgos 
	- [https://www.incibe.es/sites/default/files/contenidos/guias/doc/guia_ciberseguridad_gestion_riesgos_metad.pdf](https://www.incibe.es/sites/default/files/contenidos/guias/doc/guia_ciberseguridad_gestion_riesgos_metad.pdf)
